...
import 'package:qpay/core/provider/particular_account_provider.dart';
import 'package:qpay/feature/account/widget/header_particular_account.dart';
...
class ParticularAccountScreen extends ConsumerStatefulWidget {
  const ParticularAccountScreen({super.key});

  @override
  ConsumerState createState() => _InformationScreenState();
}

class _InformationScreenState extends ConsumerState<ParticularAccountScreen> {
  ...
  Widget build(BuildContext context) {
    var currentPage = ref.watch(particularAccountProvider);
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        onPageChanged: (value) {
          ref.read(particularAccountProvider.notifier).update((_) => value);
        },
      ),
    );
  }
